...
(fn configure-telescope-mappings []
  ...
  (map! [n] :<leader>sa "<cmd>Telescope lsp_code_actions<CR>")
  (map! [n] :<leader>sd "<cmd>Telescope lsp_document_diagnostics<CR>")
  (map! [n] :<leader>sD "<cmd>Telescope lsp_workspace_diagnostics<CR>")
